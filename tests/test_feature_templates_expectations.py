"""Feature tests for the TemplatesExpectations class.
...
def test_valid_dataset_passes(valid_df: pd.DataFrame, expectations_file: str, capsys: None):
    ...
    validator = TemplatesExpectations(valid_df, expectations_file)
...
def test_empty_dataset_fails(expectations_file: str):
    ...
    validator = TemplatesExpectations(df, expectations_file)
...
def test_wrong_column_count(valid_df: pd.DataFrame, tmp_path: str):
    ...
    validator = TemplatesExpectations(valid_df, str(file_path))
